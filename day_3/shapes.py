...
class Shape(object):
    ...
    def __int__(self, color, material, max_temperature):
        '''
        Constructor
        '''
        self.color = color
    ...
    def __eq__(self, other):
        return self.color == other.color and\
            ...
            self.max_temperature == other.max.temperature
            
class Rectangle(Shape):
    
    def __int__(self, comp, larg, color, material):
...
class Circle(Shape):
    ...
    def __int__(self, radious, color, material):
        Shape.__init__(self, color, material)
...
class Triangle(Shape):
    ...
    def __int__(self, cat1, cat2, color, material):
        Shape.__init__(self, color, material)
        self.cat1 = cat1
        self.cat2 = cat2
    def get_area(self):
...
if __name__=='__main__':
    ...
    rect = Rectangle(10,20, (0,0,0), 'wood')
